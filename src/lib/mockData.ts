...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'prod-001',
    slug: 'premium-taupe-longline-embroidered-tuxedo-coat',
    title: 'Taupe Longline Embroidered Tuxedo Coat',
    collection_id: 'col-platinum',
    base_price_gbp: 1250,
    regular_price_gbp: 1450,
    sale_price_gbp: 1250,
    description: 'An immaculate statement outerwear piece hand-tailored from premium Italian wool micro-velvet. Embellished with fine metallic bullion embroidery along the shawl lapel, cuffs, and lower hem.',
    featured_image_url: '/uploads/2026/06/Premium-Taupe-Longline-Embroidered-Tuxedo-Coat-3.webp',
    gallery_images: [
      '/uploads/2026/06/Premium-Taupe-Longline-Embroidered-Tuxedo-Coat-3.webp',
      '/uploads/2026/06/Mens-Warm-Taupe-Silk-Velvet-Blazer-3.webp',
      '/uploads/2026/05/hero-coat.jpg',
    ],
    ...
    acf_meta: {
      fabric_composition: '100% Superfine Italian Wool & Silk Micro-Velvet (520 GSM)',
      embroidery_technique: 'Hand Zardozi with Metallic Bullion and Nakshi Gold Work',
      embroidery_hours: 110,
      ...
      product_highlights: [
        { highlight: '110+ hours of hand embroidery by master artisans' },
        { highlight: 'Floating horsehair canvas chest construction' },
  ...
  {
    id: 'prod-002',
    slug: 'mens-premium-prince-coat',
    title: "Men's Premium Prince Coat",
    collection_id: 'col-platinum',
    base_price_gbp: 950,
    regular_price_gbp: 1150,
    sale_price_gbp: 950,
    description: 'An iconic South Asian formal masterpiece. Crafted in rich velvet with intricate golden zardozi embroidery adorning the mandarin band collar, cuffs, and front placket.',
    featured_image_url: '/uploads/2026/06/Mens-Premium-Prince-Coat-4.webp',
    gallery_images: [
      '/uploads/2026/06/Mens-Premium-Prince-Coat-4.webp',
      '/uploads/2026/05/hero-coat.jpg',
      '/uploads/2026/06/Mens-Slate-Blue-Double-Breasted-Overcoat-3.webp',
    ],
    stock_status: 'in_stock',
    stock_quantity: 7,
    is_featured: true,
    ...
    collection: INITIAL_COLLECTIONS[0],
    acf_meta: {
      fabric_composition: 'Imported Silk Micro-Velvet with Bemberg Cupro Silk Lining',
      embroidery_technique: 'Pure Gold Bullion Dabka and French Knot Needlework',
      embroidery_hours: 95,
      ...
      product_highlights: [
        { highlight: 'Mandarin collar with signature hand-carved knot buttons' },
        { highlight: 'Structured tailored shoulder line with floating canvas' },
      ],
    },
  ...
  {
    id: 'prod-003',
    slug: 'burgundy-wool-blazer-gold-collar',
    title: 'Burgundy Wool Blazer — Gold Celestial Collar',
    collection_id: 'col-gold',
    base_price_gbp: 750,
    regular_price_gbp: 890,
    sale_price_gbp: 750,
    description: 'An elegant bespoke blazer tailored in rich burgundy wool, framed with celestial metallic embroidery along the collar and lapels for women and men.',
    featured_image_url: '/uploads/2026/06/Womens-Burgundy-Wool-Blazer-4.webp',
    gallery_images: [
      '/uploads/2026/06/Womens-Burgundy-Wool-Blazer-4.webp',
      '/uploads/2026/05/womens-coat-1.jpg',
    ...
    acf_meta: {
      fabric_composition: '100% Super 130s Merino Wool (460 GSM)',
      embroidery_technique: 'Celestial Gold Thread Needlework & Metallic Bullion',
      embroidery_hours: 65,
      ...
      product_highlights: [
        { highlight: 'Hand-sculpted waist suppression and natural shoulder roll' },
        { highlight: 'Silk satin interior lining with welt pocket' },
      ],
    },
  ...
  },
  {
    ...
    title: 'Black Brocade Tuxedo Jacket',
    collection_id: 'col-gold',
    base_price_gbp: 850,
    regular_price_gbp: 990,
    sale_price_gbp: 850,
    description: 'Woven jacquard floral brocade with high-shine silk satin shawl lapel. Designed for black-tie galas, weddings, and red carpet events.',
    featured_image_url: '/uploads/2026/06/Black-Brocade-Tuxedo-Jacket-3.webp',
    gallery_images: [
    ...
    collection: INITIAL_COLLECTIONS[1],
    acf_meta: {
      fabric_composition: 'Jacquard Woven Silk Brocade with Pure Silk Satin Trim',
      embroidery_technique: 'Woven Floral Relief with Hand-Stitched Satin Piping',
      embroidery_hours: 50,
      care_instructions: 'Dry Clean Only.',
      product_colors: [
      ...
      product_highlights: [
        { highlight: 'Silk satin shawl lapel and matching jetted pockets' },
        { highlight: 'Single button stance with hand-covered silk button' },
      ],
    },
  ...
  {
    id: 'prod-005',
    slug: 'ivory-white-linen-tailored-blazer',
    title: 'Ivory White Linen Tailored Blazer',
    collection_id: 'col-silver',
    base_price_gbp: 650,
    regular_price_gbp: 780,
    sale_price_gbp: 650,
    description: 'Bespoke lightweight Irish linen tailored with delicate sleeve embroidery motifs. Ideal for resort wear, summer galas, and destination weddings.',
    featured_image_url: '/uploads/2026/06/Ivory-White-Linen-Tailored-Blazer-4.webp',
    gallery_images: [
    ...
    acf_meta: {
      fabric_composition: '100% Pure Irish Linen (380 GSM)',
      embroidery_technique: 'Resham Silk Needlework with Subtle Tone-on-Tone Stitching',
      embroidery_hours: 40,
      care_instructions: 'Professional Dry Clean Only.',
      product_colors: [
        { name: 'Antique Ivory', hex: '#FDFBF7' },
        { name: 'Sand Dune', hex: '#E6DEC8' },
      ],
      product_highlights: [
        { highlight: 'Unstructured breathable half-canvas construction' },
        { highlight: 'Real horn buttons and patch pockets' },
      ],
    },
  ...
  {
    id: 'prod-006',
    slug: 'black-blazer-silver-art-deco',
    title: 'Black Blazer — Art Deco Silver',
    collection_id: 'col-silver',
    base_price_gbp: 600,
    regular_price_gbp: 720,
    sale_price_gbp: 600,
    description: 'Contemporary European Art Deco linear symmetry meets tailored black wool. Embroidered with real silver metallic wire across collar and lapel borders.',
    featured_image_url: '/uploads/2026/06/Black-Blazer-3.webp',
    gallery_images: [
      '/uploads/2026/06/Black-Blazer-3.webp',
    ...
    collection: INITIAL_COLLECTIONS[2],
    acf_meta: {
      fabric_composition: 'Super 120s Wool Blend (420 GSM)',
      embroidery_technique: 'Silver Tilla Linear Cord Embroidery',
      embroidery_hours: 45,
      care_instructions: 'Specialist Dry Clean Only.',
      product_colors: [
      ...
      product_highlights: [
        { highlight: 'Sharp modern peak lapel with silver edging' },
        { highlight: 'Slim tailored fit with double back vents' },
      ],
    },
  ...
  {
    id: 'prod-007',
    slug: 'black-wool-blend-tailored-blazer-gold-floral',
    title: 'Black Wool-Blend Tailored Blazer — Gold Floral',
    collection_id: 'col-gold',
    base_price_gbp: 720,
    regular_price_gbp: 850,
    sale_price_gbp: 720,
    description: 'Heavyweight black wool-blend blazer adorned with blooming gold floral embroidery cascading down the shoulder and chest.',
    featured_image_url: '/uploads/2026/06/Black-Wool-Blend-Tailored-Blazer-11.webp',
    gallery_images: [
    ...
    collection: INITIAL_COLLECTIONS[1],
    acf_meta: {
      fabric_composition: 'Super 140s Wool (85%) & Cashmere (15%)',
      embroidery_technique: 'Gold Metallic Resham and Marori Threadwork',
      embroidery_hours: 60,
      care_instructions: 'Dry Clean Only.',
      product_colors: [
        { name: 'Sovereign Black', hex: '#0A0A0A' },
      ...
      product_highlights: [
        { highlight: 'Artisan floral embroidery placement' },
        { highlight: 'Full floating horsehair canvas' },
      ],
    },
  ...
  {
    id: 'prod-008',
    slug: 'mens-navy-blue-slim-suit-coat',
    title: "Men's Navy Blue Slim Suit Coat",
    collection_id: 'col-essentials',
    base_price_gbp: 680,
    regular_price_gbp: 780,
    sale_price_gbp: 680,
    description: 'Modern slim-cut formal suit coat in rich navy blue wool, detailed with refined tonal embroidery along the cuffs and back collar.',
    featured_image_url: '/uploads/2026/06/Mens-Navy-Blue-Slim-Suit-Coat-3.webp',
    gallery_images: [
      '/uploads/2026/06/Mens-Navy-Blue-Slim-Suit-Coat-3.webp',
      '/uploads/2026/06/Mens-Camel-Tan-Wool-Blazer-3.webp',
    ],
    stock_status: 'in_stock',
    stock_quantity: 14,
    is_featured: false,
    ...
    acf_meta: {
      fabric_composition: '100% Merino Wool Super 120s',
      embroidery_technique: 'Tonal Silk Resham Stitching',
      embroidery_hours: 35,
      care_instructions: 'Dry Clean Only.',
      product_colors: [
      ...
      product_highlights: [
        { highlight: 'Everyday elegance for formal dinners and conferences' },
        { highlight: 'Hand-finished buttonholes and pick-stitching' },
      ],
    },
